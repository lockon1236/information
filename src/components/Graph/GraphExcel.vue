<template>
  <div>
    <a-spin :spinning="spinning" tip="加载中..." size="large">
      <!-- 时间轴 -->
      <div id="timeBarCon" :style="{opacity:timeOpacity}">
        <a-row class="selectRow">
          <a-col :span="22">
            <div id="timeBar"></div>
          </a-col>
          <a-col :span="2">
            <a-button style="opacity: 2" @click="showRange">数据统计</a-button>
          </a-col>
        </a-row>
      </div>
      <!-- 文字面板 -->
      ...
      <a-row>
        <a-col :span="24">
          <div class="smallTitle" style="margin-left:2vw">Excel图谱</div>
          <div class="smallTitle" style="margin-left:62vw">要素信息</div>
        </a-col>
      </a-row>
      <a-row class="selectRow">
        <a-col :span="24">
          <div class="colDiv"></div>
          <div class="textDivTest" style="width:63vw" v-show="!gisCheck">
            <div id="analyzeGraphDiv" class="analyzeGraphDiv"></div>
          </div>
          <div id="earth_container" v-show="gisCheck"></div>
          <div class="colDiv"></div>
          <div class="textDivTest" style="width:30vw">
            <!-- 添加实体面板 -->
            <div class="shitiDiv" v-show="rightPanelName == 'attribute'" v-bind:style="entityStyle">
              ...
              <div class="attrCon">
                <a-row style="margin-top: 3%;" v-show="eventType == 'edit'">
                  <a-col :span="10">
            ...
            <div v-show="eventType == 'edit'" style="padding: 20px;">
              ...
              <a-drawer
                :title="fileDrawerName"
                :width="500"
                placement="right"
                :closable="false"
                @close="closeDrawer"
                :visible="drawerVisible"
              >{{fileContent}}</a-drawer>
            </div>
            <div class="levelCon" v-show="rightPanelName == 'level'">
              ...
              <a-row style="margin-top:2vh;line-height:32px">
                <a-col :span="6">
                  <div class="panelCircle" style="background-image: url(/static/pic/endIcon.png)"></div>
                </a-col>
                <a-col :span="6">终点名称:</a-col>
                <a-col :span="6">
                  <a-input placeholder="请输入终点名称" :value="endName" @change="endNameChange" />
                </a-col>
              </a-row>
              <a-row style="margin-top:2vh;line-height:32px">
                <a-col :span="6"></a-col>
                ...
                <a-col :span="6">
                  <a-input-number :min="1" :max="5" v-model="levelNum" @change="levelNumChange" />
                </a-col>
                <a-col :span="6">
                  <a-button style @click="searchLevel">查询</a-button>
                </a-col>
              </a-row>
              <a-table
            ...
            <a-collapse v-show="rightPanelName == 'timeRange'">
              <a-collapse-panel header="实体统计" key="1">
                <p>哈哈哈哈哈哈哈哈哈哈或或或或或或或或或</p>
              </a-collapse-panel>
              <a-collapse-panel header="属性统计" key="2" :disabled="false">
                <p>哈哈哈哈哈哈哈哈哈哈或或或或或或或或或</p>
              </a-collapse-panel>
            </a-collapse>
          </div>
      ...
      <a-modal title="数据融合" v-model="mergeState" :mask="false" :width="900" :footer="null">
        <a-row style="margin-top: 20px">
          ...
          <a-col :span="16" style="border-left:solid 1px #b8b8b8">
...
export default {
  ...
  mounted() {
    ...
    this.$store.state.graphColor3 = "#02d4ff";
    this.$store.state.imgUrl3 = "url(/static/pic/iconClick/excelBtn.png)";
    // 获取色标柱
  ...
  destroyed() {
    this.$store.state.graphColor3 = "#b8b8b8";
    this.$store.state.imgUrl3 = "url(/static/pic/icon/excelBtn.png)";
  },
  computed: {
